-- Railway MySQL Seed Data
-- Note: Pastikan sudah menjalankan schema-railway.sql terlebih dahulu

-- Insert banner data (EXACT from Swagger)
...
-- Insert services data (EXACT from Swagger - order matters!)
